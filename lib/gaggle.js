    ...
    if (self._state === STATES.LEADER) {
      ...
      if (self._rpc[methodName] == null) {
        ...
        if (usedDeprecatedAPI) {
          result = new Error('As of version 3, RPC methods are synchronous, and should return a value rather than use this callback. This warning will be removed in a future version. The offending RPC method is "' + methodName + '".')
        }
